    ...
    <div className="flex flex-col max-w-sm shadow-lg" data-aos="fade-up" data-aos-delay="100">
      ...
      <div>
        ...
        <div className="view">
          ...
          <button onClick={() => {window.location.href=url}} className="border px-8 mt-6 py-1 border-teal-300 bg-transparent hover:bg-teal-300 hover:border ease-in-out duration-700 transition-colors text-teal-300 hover:text-black font-bold w-max sticky z-[11]">VIEW PROJECT</button>
